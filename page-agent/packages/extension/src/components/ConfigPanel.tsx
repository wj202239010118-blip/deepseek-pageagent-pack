	...
	return (
		<div className="flex flex-col gap-4 p-4 relative">
			...
			<div className="flex flex-col gap-1.5">
				...
				<Input
					id="base-url"
					placeholder="http://localhost:3773/v1"
					value={baseURL}
			...
			{/* Local proxy hint */}
			{baseURL.includes('localhost:3773') && (
				<div className="p-2.5 rounded-md border border-blue-500/30 bg-blue-500/5 text-[11px] text-muted-foreground leading-relaxed">
					Using local proxy — make sure <code className="font-mono">node claude-proxy.js</code> is running
				</div>
			)}
