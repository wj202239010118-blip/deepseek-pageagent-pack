...
export default defineConfig({
	...
	vite: () => ({
		...
		define: {
			...
			__CLAUDE_API_KEY__: JSON.stringify(process.env.VITE_CLAUDE_API_KEY || ''),
		},
		optimizeDeps: {
			force: true,
		},
	...
	manifest: {
		...
		commands: {
			'page-agent-toggle-origin-allow': {
				description: 'Toggle current tab origin in Hub allowlist',
				suggested_key: { default: 'Alt+Shift+A' },
			},
			'page-agent-panic-stop': {
				description: 'Panic stop: temporarily deny sensitive ops',
